...
public class RESTServletStyle {
	...
	public Response getPOJOOrXML(@QueryParam("userId") int userId, @QueryParam("taskId") int taskId) throws URISyntaxException{
			...
			//ViksitLogger.logMSG(this.getClass().getName(),uriInfo.getBaseUri());
			//ViksitLogger.logMSG(this.getClass().getName(),uriInfo.getAbsolutePath());
			switch(task.getItemType()){
			case TaskItemCategory.LESSON:
				//ViksitLogger.logMSG(this.getClass().getName(),"Task is Video");
			...
			case TaskItemCategory.ASSESSMENT:
				//ViksitLogger.logMSG(this.getClass().getName(),"Task is Assessment");
			...
			case TaskItemCategory.JOB_STUDENT:
				//ViksitLogger.logMSG(this.getClass().getName(),"Task is Job");
